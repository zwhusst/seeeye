...
public interface FormConstants
{
    ...
    public static final String   FIELD_SUPERVISIOR_COLLEGE1 = "supervisiorcollege1";
    public static final String   FIELD_SUPERVISOR_TYPE2     = "supervisortype2";
    public static final String   FIELD_SUPERVISIOR_COLLEGE2 = "supervisiorcollege2";
    public static final String   FIELD_SUPERVISOR_TYPE3     = "supervisortype3";
    public static final String   FIELD_SUPERVISIOR_COLLEGE3 = "supervisiorcollege3";
